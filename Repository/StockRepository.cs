        ...
        public async Task<List<Stock>> GetAllAsync(QueryObject query)
        {
            ...
            if (!string.IsNullOrWhiteSpace(query.CompanyName) || !string.IsNullOrWhiteSpace(query.Symbol))
            {
                stocks = stocks.Where(s =>
                    (!string.IsNullOrWhiteSpace(query.CompanyName) && s.CompanyName.Contains(query.CompanyName)) ||
                    (!string.IsNullOrWhiteSpace(query.Symbol) && s.Symbol.Contains(query.Symbol))
                );
            }
